...
(`password_hash`) и в базе никогда не хранятся в открытом виде. Открытый
текст пароля выводится в консоль ровно один раз -- в момент создания,
...
def seed_initial_users(app):
    ...
    with app.app_context():
        ...
        print("=" * 60)
        print("Todo Planner: созданы начальные пользователи (пароли показываются только сейчас):")
