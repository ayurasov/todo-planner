...
def list_tasks(**kwargs):
    ...
    tasks = task_repository.get_visible_for_user(user_id, list_id=request.args.get("listId"),
        assignee_id=request.args.get("assigneeId"), statuses=_split_csv(request.args.get("status")),
        parent_task_id=request.args.get("parentTaskId"), tags=_split_csv(request.args.get("tags")))
...
def update_task(task_id, **kwargs):
    ...
    if not patch:
        return jsonify(domain_to_dto.task(task_repository.touch_activity(task_id)).model_dump(by_alias=True))
