...
const TYPE_ICON = {
  assigned: '👤', due_soon: '⏰', overdue: '⚠️', comment: '💬', mention: '📣',
  ...
  <div ref="panelEl" class="notif-panel card" @click.stop>
    <div class="notif-header">
      ...
      <div class="notif-actions">
        ...
        <button class="icon-btn-sm" title="Настройки уведомлений" @click="showSettings = true">⚙️</button>
      </div>
    </div>
...
.icon-btn-sm { border: none; background: none; cursor: pointer; font-size: 14px; padding: 4px; border-radius: 6px; }
.icon-btn-sm:hover { background: #eef1f7; }
